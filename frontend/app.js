...
async function shareWorkout() {
    ...
    const exercisesHtml = currentExercises.map(ex => {
        ...
        const badgesHtml = ex.sets.map((s, i) => `<span style="display:inline-block;background:#f4f4f5;border:1px solid #e4e4e7;border-radius:10px;padding:7px 10px;white-space:nowrap;outline:none;line-height:18px;"><span style="font-size:9px;font-weight:800;color:#1754cf;position:relative;top:2px;">П${i+1}</span><span style="font-size:14px;font-weight:800;color:#18181b;margin-left:3px;">${s.weight}</span><span style="font-size:9px;font-weight:500;color:#a1a1aa;position:relative;top:2px;">кг</span><span style="font-size:9px;color:#d4d4d8;margin:0 2px;position:relative;top:2px;">×</span><span style="font-size:14px;font-weight:800;color:#18181b;">${s.reps}</span></span>`).join(' ');
